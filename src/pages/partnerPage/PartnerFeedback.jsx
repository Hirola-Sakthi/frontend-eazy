        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            <div
              ...
              <h2 className="h4 sm:h3 lg:h2 m-0 text-center">Some Partners feedbacks</h2>
              <div className="row child-cols-12 sm:child-cols-6 xl:child-cols-4 justify-center col-match g-2 lg:g-3" data-uc-grid="">
                  ...
                  <div key={index}>
                    <div className="px-3 sm:px-4 py-4 panel vstack justify-between gap-3 rounded-2 border">
                      <div className="panel vstack items-start gap-2">
                        ...
                        <p className="fs-6 lg:fs-5 text-dark dark:text-white text-opacity-70">{testimonial.text}</p>
                      </div>
                      <div className="panel hstack gap-2 mt-2 lg:mt-4">
                        ...
                        <div className="panel vstack items-start gap-0">
                          ...
                          <span className="fs-7 opacity-70">{testimonial.position}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <a href="#" className="uc-link fw-bold d-inline-flex items-center gap-narrow">
