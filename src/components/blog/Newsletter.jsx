              ...
              <div>
                <div className="vstack gap-2 max-w-500px xl:max-w-600px">
                  ...
                  >
                    <div>
                      <input
                        className="form-control h-48px xl:h-56px w-full bg-white input-placeholder-color dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white"
                        type="text"
