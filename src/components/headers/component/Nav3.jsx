                  ...
                  <div className="panel vstack gap-4 py-4">
                    <div className="panel vstack gap-4">
                      <div className="hstack gap-4 justify-between">
                        ...
                        <Link
                          to={`/page-features`}
                          className="btn btn-sm text-white dark:text-white"
                        >
                          <span>See what's new</span>
                          <span className="cstack w-32px h-32px rounded-circle bg-primary-100 dark:bg-primary">
                            <i
                              className="icon-narrow unicon-arrow-right fw-bold rtl:rotate-180"
                              style={{
                                background:
                        ...
                        {features.map((feature, index) => (
                          <div key={index}>
                            ...
                            >
                              <span className="icon">
                                <i
                                  className={`icon-2 ${feature.iconClass} `}
                                  style={{
                                    background:
                                      "linear-gradient(135deg, #1338be, #2a2a72)",
                                    WebkitBackgroundClip: "text",
                    ...
                    {/* <div className="panel vstack gap-2">
                      <div className="hstack gap-4 justify-between">
                        ...
                        <Link
                          ...
                          className="btn btn-text text-black bg-none h-24px p-0 fs-8 text-uppercase dark:text-white"
                        >
                          <span className="bg-none">See +80 integrations</span>
                        </Link>
                      </div>
              ...
              <ul className="uc-nav uc-navbar-dropdown-nav p-2">
                {featuresMenu.map((feature, index) => (
                  <li key={index}>
                    ...
                    >
                      <i
                        className={`icon-1 ${feature.iconClass} fw-bold`}
                        style={{
                          background:
                            "linear-gradient(135deg, #1338be, #2a2a72)",
                          WebkitBackgroundClip: "text",
            ...
            <div>
              <ul className="uc-nav uc-navbar-dropdown-nav p-2">
                <li>
                  ...
                  >
                    <i
                      className={`icon-1 unicon-course fw-bold`}
                      style={{
                ...
                <li>
                  ...
                  >
                    <i
                      className={`icon-1 unicon-email fw-bold`}
                      style={{
                        background: "linear-gradient(135deg, #1338be, #2a2a72)",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
            ...
            <div>
              <ul className="uc-nav uc-navbar-dropdown-nav p-2 h-100 bg-gray-25 dark:bg-gray-300 dark:bg-opacity-5">
                <li>
                  ...
                  >
                    <i
                      className={`icon-1 unicon-star fw-bold`}
                      style={{
                        background: "linear-gradient(135deg, #1338be, #2a2a72)",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                ...
                <li>
                  ...
                  >
                    <i
                      className={`icon-1 unicon-headset fw-bold`}
                      style={{
                        background: "linear-gradient(135deg, #1338be, #2a2a72)",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
