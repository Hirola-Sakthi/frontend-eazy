              ...
              <div className="uc-navbar min-h-32px fs-8">
                ...
                <div className="uc-navbar-right">
                  {/* <div className="uc-navbar-item">
                    <a
                      className="btn bg-none btn-xs p-0 fs-8 text-white"
                  ...
                  <div className="uc-navbar-item">
                    <a className="btn bg-none btn-xs p-0 fs-8 text-white" href="#chat">
            ...
            <div className="uc-navbar min-h-64px lg:min-h-80px text-gray-900 dark:text-white">
              <div className="uc-navbar-left">
                <div className="uc-logo text-dark dark:text-white">
                  ...
                  >
                   <img
                      className="dark:d-none w-[75px] sm:w-[88px] "
                      alt="Eazy"
                      src="/assets/images/common/theEazy/TE WORD GRD SVG.svg"
                      width="88"
                      height="30"
                    />
              ...
              <div className="uc-navbar-right">
                <Link
                  className="btn btn-md btn-primary easy-main-gradient rounded-default lg:px-3 text-none shadow-xs d-none lg:d-inline-flex"
                  to={`/contact-us`}
                >
                  Send inquiry
                </Link>
