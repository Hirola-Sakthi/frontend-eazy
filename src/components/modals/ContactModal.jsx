...
export default function ContactModal() {
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="uc-modal-close-default text-white  button-color-white top-0 ltr:end-0 rtl:start-0 rtl:end-auto m-2 p-0 border-0 icon-2 lg:icon-3 btn btn-md dark:text-white transition-transform duration-150 hover:rotate-90"
          type="button"
