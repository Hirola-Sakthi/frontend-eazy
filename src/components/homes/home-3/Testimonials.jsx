...
export default function Testimonials({ useBackend = true }) {
  ...
  const testimonials = useBackend && backendTestimonials.length > 0
    ? backendTestimonials.map(t => ({
        quote: t.quote,
        name: t.name,
        position: t.position,
        imgSrc: t.avatarImage
      }))
    : staticTestimonials;
                ...
                <div>
                  <div className="panel">
                    ...
                    >
                      {testimonials.map((testimonial, index) => (
                        ...
                        >
                          <div className="panel vstack justify-between items-center gap-2 lg:gap-3 h-100 text-center">
                            <div className="panel">
                              <i className="icon icon-4 unicon-quotes" 
                              style={{
                          background:
                      ...
                      <div className="panel pt-0">
                        <div className=" spb1 swiper-pagination text-primary m-0 justify-center bg-none swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal" />
                      </div>
                    </Swiper>
                  </div>
                </div>
