...
export default function AnimatedIntegrationSVG() {
  return (
    ...
    >
      ...
      {/* Path 2 - First curve up (ends at y=84) */}
      <path
      ...
      {/* Path 4 - First curve down (ends at y=292) */}
      <path
      ...
      {/* Path 5 - Second curve down (ends at y=371) */}
      <path
      ...
      {/* Path 6 - Bottom curve (ends at y=440) - NEW */}
      <path
        d="M368 244V244C333.014 244 300.938 263.477 284.801 294.519L258.216 345.662C241.179 378.436 207.313 440 170.375 440H9"
        stroke="url(#paint15_linear_15_31)"
        strokeWidth="9"
      />

      {/* Dashed paths for animation */}
      <path
        id="path1-b8eb260"
        className="path"
        d="M368 188L9 188"
      ...
      <path
        ...
        className="path"
        d="M368 244V244C333.014 244 300.938 263.477 284.801 294.519L258.216 345.662C241.179 378.436 207.313 440 170.375 440H9"
        stroke="url(#paint16_linear_15_31)"
        strokeWidth="2"
        strokeDasharray="8 8"
      />
      ...
      <defs>
        ...
        {/* New gradients for path 6 */}
        <linearGradient
          id="paint15_linear_15_31"
          x1="9"
          y1="340"
          x2="368"
          y2="340"
