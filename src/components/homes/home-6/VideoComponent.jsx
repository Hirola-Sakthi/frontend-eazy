  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="container xl:max-w-xl">
            <div className="panel overflow-hidden ratio ratio-16x9 rounded-2 lg:rounded-3 border-2 border-white dark:border-gray-700">
              <video
                src="/assets/images/media/logo-video.mp4"
                preload="none"
                loop
                autoPlay
      ...
      <ModalVideo
        ...
        channel="custom"
        isOpen={isOpen}
        url="/assets/images/media/logo-video.mp4"
