export const footerLinks = [
  ...
  },
  {
    links: [
      ...
      { href: "/shop-product-detail-2/1", label: "Product detail" },
...
export const footerLinks2 = [
  ...
  },
  {
    header: "Other",
    links: [
      { href: "/terms-and-conditions", label: "FAQ" },
...
export const footerLinks3 = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/terms-and-conditions", label: "LinkedIn" },
      { href: "/page-not-found", label: "Facebook" },
      { href: "/coming-soon", label: "GitHub" },
      { href: "/terms-and-conditions", label: "AngelList" },
      { href: "/privacy-policy", label: "Dribbble" },
    ],
  },
  {
    title: "Legal",
    links: [
      ...
      { href: "/terms-and-conditions", label: "Privacy" },
      { href: "/page-not-found", label: "Cookies" },
      { href: "/coming-soon", label: "Licenses" },
      { href: "/terms-and-conditions", label: "Settings" },
      { href: "/privacy-policy", label: "Contact" },
    ],
...
export const socialLinks = [
  { href: "https://www.linkedin.com/company/the-eazy/", iconClass: "unicon-logo-linkedin" },
  { href: "https://www.facebook.com/theeazyofficial/", iconClass: "unicon-logo-facebook" },
  { href: "https://x.com/theeazyofficial", iconClass: "unicon-logo-x-filled" },
  { href: "https://www.instagram.com/theeazyofficial/", iconClass: "unicon-logo-instagram" },
  { href: "https://www.youtube.com/@officialtheeazy", iconClass: "unicon-logo-youtube" },
  { href: "https://www.pinterest.com/theeazyofficial/", iconClass: "unicon-logo-pinterest" },
