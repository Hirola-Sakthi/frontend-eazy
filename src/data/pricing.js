...
export const pricingTiers = [
  {
    ...
    price: `${getSymbolFromCurrency('INR')}19 INR`,
  ...
  },
  {
    ...
    price: `${getSymbolFromCurrency('INR')}49 INR`,
...
export const tiers3 = [
  {
    ...
    description: "For creating impressive tools that generate results.",
    price: `${getSymbolFromCurrency('INR')}19 INR`,
    yearlyPrice: `${getSymbolFromCurrency('INR')}12 INR`,
  ...
  },
  {
    ...
    description: "For seamless integrations and sending tools in bulk.",
    price: `${getSymbolFromCurrency('INR')}49 INR`,
    yearlyPrice: `${getSymbolFromCurrency('INR')}32 INR`,
