export const panels = [
  {
    id: 1,
    lightIcon: "/assets/images/common/visit-us-icon.png",
    darkIcon: "/assets/images/template/icon-location-dark.svg",
    altText: "location-icon",
    title: "Visit us",
    description: "Bangalore, 560092",
    linkText: "View on maps",
    linkUrl: "#",
  },
  {
    id: 2,
    lightIcon: "/assets/images/common/via-chat-icon.png",
  ...
  {
    id: 3,
    lightIcon: "/assets/images/common/report-issue-icon.png",
  ...
  {
    id: 4,
    lightIcon: "/assets/images/common/our-community-icon.png",
